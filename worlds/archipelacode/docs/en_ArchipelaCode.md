...
The ArchipelaCode client takes the form of a [Visual Studio Code extension](https://marketplace.visualstudio.com/items?itemName=ShackledMars261.archipelacode), allowing you to connect to Archipelago, submit problems to LeetCode, and more, all from inside VS Code.
